...
class UserController extends AbstractController
{
    ...
    public function upload(Request $request): Response
    {
        ...
        //garde une référence vers la photo de profil précédente
        ...
        if($form->isSubmitted()) {
            if ($form->isValid()) {
                ...
                //on enlève l'UploadedFile sinon ça bug avec la sérialization
        ...
        //on recharge les données du user depuis la bdd au cas où
        $em->refresh($user);
    ...
    public function edit(Request $request): Response
    {
        ...
        if ($form->isSubmitted()){
            ...
            if ($form->isValid()){
                ...
                //sinon ça bug dans la session, ça me déconnecte
